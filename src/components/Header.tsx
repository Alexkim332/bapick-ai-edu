        ...
        <div className="flex items-center gap-4">
          {user ? (
            <>
              ...
              <Link
                href="/mypage"
                className="inline-flex items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-medium text-text-main border border-border shadow-sm hover:bg-gray-50 transition-colors"
              >
                마이페이지
              </Link>
              <form action={logout}>
